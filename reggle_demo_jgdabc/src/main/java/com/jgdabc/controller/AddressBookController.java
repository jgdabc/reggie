...
public class AddressBookController {
     ...
     */
    @PostMapping
    public R_<AddressBook> save(@RequestBody AddressBook addressBook) {
     ...
     */
    @PutMapping("default")
    public R_<AddressBook> setDefault(@RequestBody AddressBook addressBook) {
        log.info("addressBook:{}", addressBook);
     ...
     */
    @GetMapping("default")
    public R_<AddressBook> getDefault() {
     ...
     */
    @GetMapping("/list")
    public R_<List<AddressBook>> list(AddressBook addressBook) {
        addressBook.setUserId(BaseContext.getCurrentId());
        log.info("addressBook:{}", addressBook);
